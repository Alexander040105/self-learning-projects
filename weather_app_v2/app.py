...
def weatherApi():
    ...
    api_key = '67b4cb11470a49dd817142325241003'
    ...
    return temperature, icon, longitude, latitude, weatherType
...
def display():
    ...
    if not city:
        ...
        city2 = ((" of " + city))
        temperature, icon, longitude, latitude, weatherType = weatherApi()
        plot_base64, pollutants_aqi, pollutants_concentration = processing_image()
        return render_template("index.html", plot_base64=plot_base64, pollutantsAqi=pollutants_aqi, 
                            pollutantsConcentration=pollutants_concentration, city2=city2, city=city,
                            temperature=temperature, weatherType=weatherType, icon=icon, latitude=latitude,
                            longitude=longitude)
