...
def getDetails():
    ...
    check_up = request.form.get("check_up")
    ...
    sheet1.update_cell(empty_row, 4, clientAddress)
    
    sheet1.update_cell(empty_row, 5, cleaning)
    sheet1.update_cell(empty_row, 6, check_up)
    sheet1.update_cell(empty_row, 7, dismantle)
    sheet1.update_cell(empty_row, 8, relocation)
    sheet1.update_cell(empty_row, 9, installation)
